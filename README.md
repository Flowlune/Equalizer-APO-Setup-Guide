...
8. После всех изменений нажмите на кнопку **Применить** и **ОК**.
...
---
>[!NOTE]
>Неважно, какой у вас микрофон — будь то **Fifine**, **Blue Yeti**, **HyperX QuadCast**, **HyperX SoloCast**, — после всех манипуляций с ним он у вас будет звучать ещё краше, чище и лучше.
---
...
> [!NOTE]
> Конфигурации имеют расширение **.txt**

---

> [!NOTE]
> VST-плагины имеют расширение **.dll**

---

> [!IMPORTANT]
> После изменения конфигурации и нажатия кнопок **Apply Automatically** **Apply** изменения применяются автоматически.

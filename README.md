...
Это помогает развитию проекта и делает его более заметным для других пользователей.
...
Если после завершения установки появится окно с предупреждением —
...
> ```
>
> Если Windows не позволяет создать копию из-за недостатка прав, откройте **Терминал Windows** или **Командную строку** от имени администратора и выполните команду:
>
> ```cmd
...
>
> ### Альтернативные способы открыть Командную строку
>
> **Способ 1 (самый простой)**
>
> - Откройте папку, в которой хотите работать.
...
> **Способ 2**
>
> - Создайте папку, например **Backup**, на Рабочем столе или в папке **Документы**.
> - Откройте её.

...
6. Поставь уровень громкости на **75–80%**.
7. Во вкладке **Дополнительно** нужно отключить галочку у **монопольного режима**.
8. После всех настроек нажми на кнопку **Применить** и **ОК**.
